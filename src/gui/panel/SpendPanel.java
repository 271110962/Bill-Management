...
public class SpendPanel extends WorkingPanel{
	...
	JLabel lMonthSpend = new JLabel("Consumption This Month");
	JLabel lTodaySpend = new JLabel("Today Consumption");
	JLabel lAvgSpendPerDay = new JLabel("Average Consumption PerDay");
	JLabel lMonthLeft = new JLabel("Remaining This Month");
	JLabel lDayAvgAvailable = new JLabel("Daily Average Available");
	JLabel lMonthLeftDay = new JLabel("End of Month");
